export const FEED_SOURCES = {
  ...
  local: [
    { name: 'Seattle News', url: 'https://news.google.com/rss/search?q=Seattle+news+when:3d&hl=en-US&gl=US&ceid=US:en' },
    { name: 'Tacoma News', url: 'https://news.google.com/rss/search?q=Tacoma+Washington+news+when:3d&hl=en-US&gl=US&ceid=US:en' },
    { name: 'Pacific Northwest', url: 'https://news.google.com/rss/search?q=Pacific+Northwest+Washington+state+news+when:3d&hl=en-US&gl=US&ceid=US:en' },
    { name: 'Puget Sound', url: 'https://news.google.com/rss/search?q=Puget+Sound+Bellevue+Redmond+news+when:3d&hl=en-US&gl=US&ceid=US:en' },
